...
$this->load->view('admin/adm_sidebar');
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ly"> <a href="<?php echo base_url('Admin/') ?>"> <i class="icon-inbox"></i><span class="label label-success">101</span> Category Article </a> </li>
...
<?php $this->load->view('admin/adm_footer'); ?>
